...
library SGSDK;
  ...
  procedure sg_Geometry_VectorToString(var v: Vector; result: PChar); cdecl; export;
    var
      result_temp: String;
  begin
    {$IFDEF TRACE}
      TraceEnter('SGSDK.dll', 'sg_Geometry_VectorToString');
    {$ENDIF}
    
    try
      result_temp := sgGeometry.VectorToString(v);
        StrCopy(result, PChar(result_temp));
    Except on exc: Exception do 
      TrapException(exc, 'sg_Geometry_VectorToString');
    end;  
    
    {$IFDEF TRACE}
      TraceExit('SGSDK.dll', 'sg_Geometry_VectorToString');
    {$ENDIF}
  end;
  ...
  function sg_Input_MouseWheelScroll(): Vector; cdecl; export;
  begin
    {$IFDEF TRACE}
      TraceEnter('SGSDK.dll', 'sg_Input_MouseWheelScroll');
    {$ENDIF}
    
    try
      result := sgInput.MouseWheelScroll();
    Except on exc: Exception do 
      TrapException(exc, 'sg_Input_MouseWheelScroll');
    end;  
    
    {$IFDEF TRACE}
      TraceExit('SGSDK.dll', 'sg_Input_MouseWheelScroll');
    {$ENDIF}
  end;
  ...
  begin
    ...
    sg_Input_MouseWheelScroll name {$IFDEF DARWIN}'_sg_Input_MouseWheelScroll'{$ELSE}'sg_Input_MouseWheelScroll'{$ENDIF},
    ...
    sg_Geometry_VectorToString name {$IFDEF DARWIN}'_sg_Geometry_VectorToString'{$ELSE}'sg_Geometry_VectorToString'{$ENDIF},
